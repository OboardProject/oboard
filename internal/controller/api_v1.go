...
func (s *Server) registerAPIV1Routes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/servers", s.apiAuth(s.apiV1Servers, model.RoleOperator))
	mux.HandleFunc("/api/v1/servers/", s.apiAuth(s.apiV1Server, model.RoleOperator))
	mux.HandleFunc("/api/v1/latency-probes", s.apiAuth(s.apiV1LatencyProbes, model.RoleOperator))
	mux.HandleFunc("/api/v1/users", s.apiAuth(s.apiV1Users, model.RoleAdmin))
	mux.HandleFunc("/api/v1/topology", s.apiAuth(s.apiV1Topology, model.RoleOperator))
	mux.HandleFunc("/api/v1/audit/incidents", s.apiAuth(s.apiV1AuditIncidents, model.RoleOperator))
	mux.HandleFunc("/api/v1/audit/incidents/", s.apiAuth(s.apiV1AuditIncident, model.RoleOperator))
	mux.HandleFunc("/api/v1/node-incidents", s.apiAuth(s.apiV1NodeIncidents, model.RoleOperator))
	mux.HandleFunc("/api/v1/node-incidents/", s.apiAuth(s.apiV1NodeIncidents, model.RoleOperator))
