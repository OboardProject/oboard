...
func TestDockerInstallAndReleaseAssets(t *testing.T) {
	...
	checks := map[string][]string{
		...
		"scripts/fetch-agent-release.sh":      {"OBOARD_RELEASE_PUBLIC_KEY", "gh release download", "release-manifest.json.sig", "OBOARD_AGENT_CHANNEL"},
		".github/workflows/ci.yml":            {"verify-release.sh", "go-version: '1.25.11'", "node-version: '22'"},
