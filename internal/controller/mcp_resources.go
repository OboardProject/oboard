...
func (s *Server) mcpResourceDefs() []mcpResourceDef {
	return []mcpResourceDef{
		...
		{uri: "oboard://node-presets", title: "Node Presets", name: "Node presets", description: "Return reusable inbound configuration templates for VLESS, HY2, AnyTLS, Shadowsocks, Mieru, and SOCKS5. Templates contain no secrets.", capability: "node_presets.list", kind: "query"},
