...
export function MCPAccessPage({ request, requestV2, notify, confirm }: MCPAccessPageProps) {
  return (
    <>
      <div className="automation-grid">
        <OAuthClientList requestV2={requestV2} notify={notify} confirm={confirm} />
      </div>
      <OAuthGrantList request={request} requestV2={requestV2} notify={notify} confirm={confirm} />
    </>
  )
}
