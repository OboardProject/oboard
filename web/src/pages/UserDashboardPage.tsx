    ...
    <div className="signal-overview" aria-busy={loading}>
      <section className="signal-overview-usage" aria-label="账户使用概览">
        <div className="signal-overview-traffic">
          ...
          <div className="signal-overview-period"><span>周期结束</span>{overview.traffic.period_end ? <time dateTime={overview.traffic.period_end}>{formatAnnouncementTime(overview.traffic.period_end)}</time> : <span>暂未提供</span>}</div>
        </div>
